        ...
        <div className="glass-panel rounded-lg p-6 space-y-5">
          <div>
            ...
            {loading ? (
              ...
              <div className="flex gap-2">
                <div
                  className="flex-1 px-4 py-3 rounded font-mono text-sm break-all select-all"
              ...
              <div className="p-3 rounded text-sm text-red-400"
          ...
          <div className="pt-4 border-t border-oni-border">
            ...
            <ol className="space-y-2 text-xs text-oni-dim">
              ...
              <li className="flex gap-2"><span className="text-oni-accent font-bold">2.</span><span>Másold be a fenti tokent a popup-ban megjelenő mezőbe</span></li>
